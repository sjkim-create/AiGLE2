                    ...
                    <div key={q.id} style={card}>
                      ...
                      {q.criteria.map((c, ci) => (
                        <div key={c.id} style={{ border: '1px solid #E2E8F0', borderRadius: 10, padding: '12px 14px', marginBottom: 10 }}>
                          ...
                          <div style={{ fontSize: 'var(--neo-font-size-xs)', color: '#94A3B8', fontWeight: 600, marginBottom: 10 }}>배점을 입력하면 구간(기본 3개, 배점 → 0점)에 균등 분배됩니다. 아래 표에서 각 구간 점수를 직접 수정할 수 있고, 각 행의 ⁝ 메뉴(수식 편집 · 아래에 추가 · 삭제)로 구간 수를 바꿀 수 있으며, [↻ 점수 균등 분배]로 되돌릴 수 있습니다. (0~배점, 정수)</div>
